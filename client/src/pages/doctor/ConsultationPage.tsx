                ...
                <div className="lg:col-span-2 space-y-6">
                    <Card className="border-none shadow-xl rounded-[2.5rem] p-8">
                        <div className="space-y-8">
                            ...
                            <div className="pt-6 border-t border-slate-100 flex flex-col md:flex-row gap-4">
                                <Button
                                    ...
                                    onClick={() => navigate(`/doctor/prescriptions/new?aptId=${appointmentId}`)}
                                >
                        ...
                        <div className="mt-12 flex gap-4">
                            <Button
                                className="h-16 flex-[2] bg-emerald-600 hover:bg-emerald-700 text-white font-black text-lg rounded-3xl shadow-xl shadow-emerald-100 gap-3"
                                onClick={() => endConsultationMutation.mutate()}
                                disabled={!diagnosis || endConsultationMutation.isPending}
                            >
                                <CheckCircle2 className="h-6 w-6" />
                                SAVE & END CONSULTATION
                            </Button>
                            <Button variant="ghost" className="h-16 flex-1 rounded-3xl font-black text-slate-400">
                                SAVE DRAFT
                            </Button>
                        </div>
                    </Card>
