                    ...
                    <div className="bg-gradient-to-r from-blue-700 to-indigo-800 p-8 pt-12 pb-16 relative">
                        ...
                        <div className="flex flex-col items-center justify-center gap-2 text-white">
                            <div className="flex items-center gap-3">
                                ...
                                <h1 className="text-3xl font-black uppercase tracking-tight">Nursing Portal</h1>
                            </div>
                            <p className="text-blue-100 font-bold text-xs uppercase tracking-[0.3em]">Patient Care Authentication</p>
                        </div>
                    </div>
                        ...
                        <div className="flex-1 space-y-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="space-y-2">
                                    <Label className="ml-6 text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">Nurse ID *</Label>
                                ...
                                <div className="space-y-2">
                                    <Label className="ml-6 text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">Security Pin *</Label>
                                    <Input
                                        type="password"
                                        name="password"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <Label className="ml-6 text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">Duty Shift *</Label>
                                        <select
                                            name="shift"
                                    ...
                                    <div className="space-y-2">
                                        <Label className="ml-6 text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">Session Duration *</Label>
                                        <select
                                            name="sessionTime"
                                ...
                                >
                                    {loginLoading ? <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-white" /> : <Siren className="h-6 w-6" />}
                                    NURSE LOGIN
                                </Button>
                            </form>
                        ...
                        <div className="flex-1 flex flex-col items-center">
                            <div className="w-full h-full min-h-[500px] bg-gradient-to-br from-slate-50 to-indigo-50/30 rounded-[4rem] border-2 border-dashed border-slate-100 p-12 flex flex-col items-center justify-center text-center shadow-inner relative overflow-hidden group">
                                {showProfile && selectedStaff ? (
                                    ...
                                    <div className="space-y-6 opacity-30">
                                        <div className="w-64 h-64 rounded-full bg-teal-100 flex items-center justify-center border-4 border-white shadow-xl mx-auto">
                                            <Heart className="h-32 w-32 text-teal-200" />
                                        </div>
                                        <div className="space-y-2">
                                            <p className="text-2xl font-black text-teal-300 uppercase tracking-tighter">Nurse Identity</p>
                                            <p className="text-xs font-bold text-teal-300 uppercase tracking-[0.2em]">Enter ID to start shift</p>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="absolute bottom-10 left-10 right-10 bg-white/80 backdrop-blur p-6 rounded-[2.5rem] border border-blue-50 shadow-sm flex gap-4 items-start text-left">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black text-indigo-600 uppercase tracking-widest mb-1">Clinical Protocol:</p>
                                        <p className="text-[10px] font-bold text-slate-400 leading-relaxed uppercase">
                                            All clinical access is monitored. Ensure your shift details are accurate for patient record integrity.
                                        </p>
                                    </div>
                                </div>
                            </div>
