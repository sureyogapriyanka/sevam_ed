                ...
                <div className="w-full bg-white rounded-[4rem] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.06)] border border-slate-100 flex flex-col overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r from-blue-700 to-indigo-800 p-8 pt-12 pb-16 relative">
                        ...
                        <div className="flex flex-col items-center justify-center gap-2 text-white">
                            <div className="flex items-center gap-3">
                                ...
                                <h1 className="text-3xl font-black uppercase tracking-tight">Receptionist Portal</h1>
                            </div>
                            <p className="text-blue-100 font-bold text-xs uppercase tracking-[0.3em]">Front Desk Authentication</p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row p-12 lg:p-16 gap-16 mt-[-40px] bg-white rounded-t-[4rem]">
                        ...
                        <div className="flex-1 space-y-8">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="space-y-2">
                                    <Label className="ml-6 text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">Staff ID *</Label>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        <Label className="ml-6 text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">Shift *</Label>
                                        <select
                                            name="shift"
                                ...
                                >
                                    {loginLoading ? <div className="animate-spin rounded-full h-6 w-6 border-b-2 border-white" /> : <KeyRound className="h-6 w-6" />}
                                    RECEPTION LOGIN
                                </Button>
                            </form>
                            ...
                            <div className="p-8 bg-blue-50/50 rounded-[3rem] border border-blue-100 space-y-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-[10px] font-black text-blue-400 uppercase tracking-[0.2em]">Demo Staff Accounts</p>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 text-[10px] font-black uppercase">
                                    <p className="text-blue-600">REC001: <span className="text-blue-400">RECEPTION2024</span></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex-1 flex flex-col items-center">
                            <div className="w-full h-full min-h-[500px] bg-gradient-to-br from-slate-50 to-blue-50/30 rounded-[4rem] border-2 border-dashed border-slate-200 p-12 flex flex-col items-center justify-center text-center shadow-inner relative overflow-hidden group">
                                {showProfile && selectedStaff ? (
                                    <div className="space-y-10 animate-in fade-in zoom-in duration-700">
                                        <div className="relative">
                                            <div className="absolute inset-0 bg-slate-600 rounded-full blur-[40px] opacity-10 group-hover:opacity-20 transition-opacity" />
                                    ...
                                    <div className="space-y-6 opacity-30">
                                        ...
                                        <div className="space-y-2">
                                            <p className="text-2xl font-black text-slate-300 uppercase tracking-tighter">Staff Identity</p>
                                            <p className="text-xs font-bold text-slate-300 uppercase tracking-[0.2em]">Enter ID to start shift</p>
                                        </div>
                                    </div>
                                )}
                                ...
                                <div className="absolute bottom-10 left-10 right-10 bg-white/80 backdrop-blur p-6 rounded-[2.5rem] border border-blue-50 shadow-sm flex gap-4 items-start text-left">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-black text-indigo-600 uppercase tracking-widest mb-1">Service Protocol:</p>
                                        <p className="text-[10px] font-bold text-slate-400 leading-relaxed uppercase">
                                            All front desk activities are recorded for service excellence and security compliance.
                                        </p>
                                    </div>
                                </div>
                            </div>
